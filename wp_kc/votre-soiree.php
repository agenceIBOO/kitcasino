...
?>
  ...
  <main role="main">
    ...
    <div class="devis">
      <div class="wrapper">
        <form method="post" action="<?php echo get_permalink(109) ?>" id="msform">
        <!-- progressbar -->
          ...
          <fieldset>
            ...
            <span id="locationField">
              <input id="autocomplete" name="adresse2" onFocus="geolocate()" type="text" size="50" placeholder="Adresse de l'évènement" autofocus></input>
            </span><br>
